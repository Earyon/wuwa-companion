...
(async()=>{
 ...
 try{
  for(const language of ['fr','en']){
   ...
   await open();await page.locator('[data-echo-action="slot"][data-value="2"]').click();await page.locator('[data-echo-action="pick"][data-value="2"]').click();await page.locator('#echoPickerAdd').click();await page.locator('#echoPicker [data-value="6001"]').click();await page.locator('[data-echo-picker-apply]').click();await submit();await page.locator('#editorClose').click();assert.equal(await count(),2,'New draft copy is cancelled with character');
   await open();await page.locator('[data-echo-action="slot"][data-value="2"]').click();await page.locator('[data-echo-action="pick"][data-value="2"]').click();await page.locator('#echoPickerAdd').click();await page.locator('#echoPicker [data-value="6001"]').click();await page.locator('[data-echo-picker-apply]').click();await form.locator('[name="level"]').fill('0');await submit();await page.locator('#editorSave').click();assert.equal(await count(),3,'New draft copy commits with the character');

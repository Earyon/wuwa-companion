...
(async()=>{
 ...
 try{
  ...
  // otherwise this probe can still navigate through the previous controller.
  ...
  assert.equal(await probe.evaluate(()=>typeof CompanionStore.exportData),'function','Personal backup works offline');

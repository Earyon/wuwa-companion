...
# Menus complémentaires — 14 septembre 2026

Les cinq rubriques utilisent la navigation verticale et les références officielles déjà intégrées. Attributs reprend l'ordre actuel des six caractéristiques, la progression et les styles de combat ; Arme ajoute ses deux caractéristiques au niveau renseigné, son effet au rang actuel et la consultation des autres rangs. Les Échos partagent un rail de cinq emplacements, une vue de l'exemplaire, les attributs cumulés et les effets de Sonate. Les doublons d'un même Écho ne multiplient pas le nombre de pièces affiché pour la Sonate. Le volet Compétences ajoute l'onglet Détails avec les valeurs locales du niveau choisi. La chaîne conserve ses coordonnées sources.

Les icônes de statistiques, de styles et d'ascension sont originales. La police reste celle du système ; les illustrations 2D restent distinctes du modèle animé du jeu. Les transitions d'opacité respectent la préférence de réduction des animations et ne prétendent pas reproduire les animations Unreal. Les valeurs de base, d'arme et d'Échos sont séparées : aucun total conditionnel ou état du compte Kuro n'est inventé.

Sur tablette en paysage compact, le volet de compétence réserve une zone lisible au premier détail, et le rail d'Échos conserve cinq cibles d'au moins 44 pixels avec commandes visibles. Le fond du panneau Attributs garde le texte lisible devant l'illustration. La géométrie de l'arbre est établie pendant le rendu pour éviter une image intermédiaire où son détail se rétractait. Les variantes ont été inspectées sur captures ; elles ne constituent pas une reproduction du moteur 3D ni une mesure sur tablette physique.

## Sélecteur d'Échos — vidéo 01:32 à 01:49

Le choix d'un exemplaire reprend le parcours observé : cinq emplacements à gauche, grille de trois colonnes en paysage, filtres de coût Tous/1/3/4, miniature avec niveau, qualité et portrait du propriétaire, puis illustration et détail à droite. Toucher la miniature ne change pas l'équipement. Une commande distincte équipe, déplace ou retire l'exemplaire ; le transfert depuis un autre Résonateur nomme explicitement son propriétaire. Le remplacement libère l'ancien exemplaire sans le supprimer. Tout reste dans le brouillon jusqu'à l'enregistrement de la fiche.

Les filtres de Sonate, d'équipement et de tri complètent la recherche par nom. Les Échos inconnus conservent leurs données ; un coût inconnu ne devient pas un coût confirmé de zéro. Un dépassement connu de 12 empêche l'équipement. Le sélecteur réutilise la même grille pour choisir un type d'Écho depuis le catalogue, y compris dans le formulaire d'ajout. La sélection conserve son identifiant et les valeurs déjà saisies.

Les images sont les miniatures et illustrations officielles déjà référencées, chargées à la demande. La description utilise le cache partagé avec l'encyclopédie et les Sonates réutilisent le calcul des espèces distinctes. Sur téléphone, la grille et le détail alternent avec un retour explicite ; en paysage compact, l'illustration rejoint le panneau de détail. Les cinq emplacements et les actions gardent des cibles de 44 pixels. Les lignes de la grille ont une hauteur intrinsèque pour ne pas superposer les miniatures lorsque leur contenu dépasse la zone défilante.

Les différences avec le jeu restent explicites : illustration 2D, inventaire déclaré manuellement et modification des valeurs sans consommation de matériaux dans Kuro. Le verrouillage et les suggestions automatiques du jeu ne sont pas simulés ; les recommandations et objectifs restent masqués.

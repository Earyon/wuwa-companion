...
const CACHE_NAME=CACHE_PREFIX+'057-pwa-7';
const SHELL=['./','./index.html','./styles.css','./layout.css','./manifest.webmanifest','./pwa.js','./assets/icon-192.png','./assets/icon-512.png'];

...
const CACHE_NAME=CACHE_PREFIX+'057-pwa-13';
const SHELL=['./','./index.html','./styles.css','./layout.css','./companion.css','./catalog.js','./dialogs.js','./editor-view.js','./app.js','./skills.js','./account-editor.js','./bootstrap.js','./account-store.js','./companion-ui.js','./inventory.js','./planning.js','./forte.js','./manifest.webmanifest','./pwa.js','./assets/icon-192.png','./assets/icon-512.png'];

...
const CACHE_NAME=CACHE_PREFIX+'057-pwa-8';
const SHELL=['./','./index.html','./styles.css','./layout.css','./forte.js','./manifest.webmanifest','./pwa.js','./assets/icon-192.png','./assets/icon-512.png'];
